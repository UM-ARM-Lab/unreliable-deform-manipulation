...
def main():
    ...
    for i in range(1000):
        ...
        violated = model.violated(rope_configuration)
        ...
        if i < 5:
            ...
            if true_violated:
                ...
                true_color = 'g'
            plt.scatter(rope_configuration[0, 4], rope_configuration[0, 5], s=100, c=pred_color, label='pred')
            plt.scatter(rope_configuration[0, 4], rope_configuration[0, 5], s=10, c=true_color, label='true')
            plt.legend()

    print('accuracy:', (true_positives + true_negatives) / (true_positives + false_positives + true_negatives + false_negatives))
