...
from moonshine.get_local_environment import get_local_env_and_origin_np, get_local_env_and_origin_differentiable
...
for j in range(2):
    ...
    plt.imshow(np.flipud(local_env[j]), extent=local_extent, alpha=0.3, cmap='Greys')
