...
class SingleImageClassifier(MyKerasModel):
...
class SingleImageClassifierWrapper(BaseConstraintChecker):
    ...
    def __init__(self, path: pathlib.Path, batch_size: int, scenario: ExperimentScenario):
        ...
        self.net = SingleImageClassifier(hparams=self.model_hparams, batch_size=batch_size, scenario=scenario)
...
model = SingleImageClassifierWrapper
