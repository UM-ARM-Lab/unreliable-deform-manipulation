#!/bin/bash
./scripts/collect_dynamics_data.py gazebo dual collect_dynamics_params/car.json 400 fwd_model_data/car
...
./scripts/train_test_classifier.py train classifier_data/car/ hparams/classifier/dual.json -l car --epochs 10
