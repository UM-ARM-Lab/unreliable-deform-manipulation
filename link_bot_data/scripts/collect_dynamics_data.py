...
def main():
    ...
    parser.add_argument("--steps-per-traj", type=int, default=10, help='steps per traj')
    ...
    parser.add_argument("--movable-obstacles", type=str, help='names of movable objects, comma seperated')
